	...
	#define V_COMMIT_HASH "ead5e66"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "6d47dd2"
#endif
...
typedef struct main__J112tye main__J112tye;
...
typedef struct main__Tes main__Tes;
...
#if __has_include(<3.h>)
#include <3.h>
#else
#error VERROR_MESSAGE Header file <3.h>, needed for module `main` was not found. Please install the corresponding development headers.
#endif
...
// Union sum type main__J112tye = 
//          |    7 = int                 
//          |   20 = string              
//          |   15 = f32                 
//          |    2 = voidptr             
struct main__J112tye {
	union {
		int* _int;
		string* _string;
		f32* _f32;
...
static string main__J112tye_str(main__J112tye x); // auto
static string indent_main__J112tye_str(main__J112tye x, int indent_count); // auto
...
VV_LOCAL_SYMBOL main__J112tye main__vlu_to_typ_T_int(string s);
VV_LOCAL_SYMBOL main__J112tye main__vlu_to_typ_T_string(string s);
VV_LOCAL_SYMBOL main__J112tye main__vlu_to_typ_T_main__Tes(string s);
...
static string main__J112tye_str(main__J112tye x) { return indent_main__J112tye_str(x, 0); }
static string indent_main__J112tye_str(main__J112tye x, int indent_count) {
	switch(x._typ) {
		case 7: return str_intp(2, _MOV((StrIntpData[]){
				{_SLIT("J112tye("), 0xfe10, {.d_s = int_str(*(int*)x._int)}},
				{_SLIT(")"), 0, {.d_c = 0 }}
			}));		case 20: return str_intp(2, _MOV((StrIntpData[]){
				{_SLIT("J112tye('"), 0xfe10, {.d_s = string_str(*(string*)x._string)}},
				{_SLIT("')"), 0, {.d_c = 0 }}
			}));		case 15: return str_intp(2, _MOV((StrIntpData[]){
				{_SLIT("J112tye("), 0xfe10, {.d_s = f32_str(*(f32*)x._f32)}},
				{_SLIT(")"), 0, {.d_c = 0 }}
			}));		case 2: return str_intp(2, _MOV((StrIntpData[]){
				{_SLIT("J112tye("), 0xfe10, {.d_s = voidptr_str(*(voidptr*)x._voidptr)}},
				{_SLIT(")"), 0, {.d_c = 0 }}
			}));		default: return _SLIT("unknown sum type value");
	}
}

static inline main__J112tye int_to_sumtype_main__J112tye(int* x) {
	int* ptr = memdup(x, sizeof(int));
	return (main__J112tye){ ._int = ptr, ._typ = 7};
}

static inline main__J112tye string_to_sumtype_main__J112tye(string* x) {
	string* ptr = memdup(x, sizeof(string));
	return (main__J112tye){ ._string = ptr, ._typ = 20};
}
...
static char * v_typeof_sumtype_main__J112tye(int sidx) { /* main.J112tye */ 
	switch(sidx) {
		case 109: return "J112tye";
		case 7: return "int";
		case 20: return "string";
		case 15: return "f32";
		case 2: return "voidptr";
		default: return "unknown J112tye";
	}
}

int v_typeof_sumtype_idx_main__J112tye(int sidx) { /* main.J112tye */ 
	switch(sidx) {
		case 109: return 109;
		case 7: return 7;
		case 20: return 20;
...
VV_LOCAL_SYMBOL voidptr map_get(map* m, voidptr key, voidptr zero) {
	multi_return_u32_u32 mr_14550 = map_key_to_index(m, key);
	u32 index = mr_14550.arg0;
	u32 meta = mr_14550.arg1;
	for (;;) {
		if (meta == m->metas[index]) {
			int kv_index = ((int)(m->metas[index + 1U]));
			voidptr pkey = DenseArray_key(&m->key_values, kv_index);
...
VV_LOCAL_SYMBOL bool map_exists(map* m, voidptr key) {
	multi_return_u32_u32 mr_15729 = map_key_to_index(m, key);
	u32 index = mr_15729.arg0;
	u32 meta = mr_15729.arg1;
	for (;;) {
		if (meta == m->metas[index]) {
			int kv_index = ((int)(m->metas[index + 1U]));
			voidptr pkey = DenseArray_key(&m->key_values, kv_index);
...
// Attr: [unsafe]
void map_delete(map* m, voidptr key) {
	multi_return_u32_u32 mr_16358 = map_key_to_index(m, key);
	u32 index = mr_16358.arg0;
	u32 meta = mr_16358.arg1;
	multi_return_u32_u32 mr_16394 = map_meta_less(m, index, meta);
	index = mr_16394.arg0;
	meta = mr_16394.arg1;
	for (;;) {
		if (!(meta == m->metas[index])) break;
...
VV_LOCAL_SYMBOL void main__main(void) {
	main__J112tye a = main__vlu_to_typ_T_int(_SLIT("152"));
	println(main__J112tye_str(a));
	println(_SLIT("J112tye"));
	main__J112tye b = main__vlu_to_typ_T_string(_SLIT("aaaaa"));
	println(main__J112tye_str(b));
	println(_SLIT("J112tye"));
	main__J112tye c = main__vlu_to_typ_T_string(_SLIT("3.14"));
	println(main__J112tye_str(c));
	println(_SLIT("J112tye"));
	main__J112tye d = main__vlu_to_typ_T_main__Tes(_SLIT("3.14"));
	println(main__J112tye_str(d));
	println(_SLIT("J112tye"));
}
...
VV_LOCAL_SYMBOL main__J112tye main__vlu_to_typ_T_int(string s) {
	#if 7 == 7
	{
		main__J112tye _t1 = int_to_sumtype_main__J112tye(ADDR(int, (string_int(s))));
		return _t1;
	}
	#endif
	#if 7 == 15
...
VV_LOCAL_SYMBOL main__J112tye main__vlu_to_typ_T_string(string s) {
	...
	#if 20 == 20
	{
		main__J112tye _t1 = string_to_sumtype_main__J112tye(&s);
		return _t1;
	}
	#endif
	main__J112tye _t2 = jsonTestF();
